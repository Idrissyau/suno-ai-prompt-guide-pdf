...
## The Anatomy of a Perfect Suno AI Prompt Stack

Through rigorous testing across thousands of generations, a definitive formula has emerged for structuring the main prompt box. The most effective method is called **Top-Loading**—placing strict architectural instructions at the very beginning of the prompt to anchor the model before adding genre details.

An optimized prompt stack follows this four-tier hierarchy:
...
## Mastering Metatags in the Lyrics Box

The true secret to arranging a multi-minute track lies within the **Lyrics Box** (when using Custom Mode). You must guide the AI through standard song architecture using uppercase metatags wrapped in square brackets. This prevents the vocals from running together and forces the instruments to shift energy dynamically.

Use this foundational layout for your custom lyrics:

```text
[Instrumental Intro]
[Atmospheric synth pads build up]

[Verse 1]
(Write or paste your verse lyrics here...)

[Pre-Chorus]
[Rhythm intensifies, snare rolls]
(Write building lines here...)

[Chorus]
[Explosive hook, full arrangement, soaring vocals]
(Write your main catchy hook lyrics here...)

[Guitar Solo]
[Melodic, expressive electric guitar solo]

[Verse 2]
[Strip back instruments, bass and drums only]
...
[Outro]
[Fade out, lingering reverb, solo piano]
